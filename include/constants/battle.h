...
#define FIELD_CONDITION_SNOWSTORM           (1 << 6)
#define FIELD_CONDITION_SNOWSTORM_PERMANENT (1 << 7)
#define FIELD_CONDITION_SNOWSTORM_ALL       (FIELD_CONDITION_SNOWSTORM | FIELD_CONDITION_SNOWSTORM_PERMANENT)
#define FIELD_CONDITION_GRAVITY             (7 << 12)
#define FIELD_CONDITION_FOG                 (1 << 15)
#define FIELD_CONDITION_TRICK_ROOM          (7 << 16)

#define FIELD_CONDITION_WEATHER_NO_SUN      (FIELD_CONDITION_RAIN_ALL | FIELD_CONDITION_SANDSTORM_ALL | FIELD_CONDITION_SNOWSTORM_ALL | FIELD_CONDITION_FOG)
#define FIELD_CONDITION_WEATHER_CASTFORM    (FIELD_CONDITION_RAIN_ALL | FIELD_CONDITION_SUN_ALL | FIELD_CONDITION_SNOWSTORM_ALL)
#define FIELD_CONDITION_WEATHER             (FIELD_CONDITION_RAIN_ALL | FIELD_CONDITION_SANDSTORM_ALL | FIELD_CONDITION_SUN_ALL | FIELD_CONDITION_SNOWSTORM_ALL | FIELD_CONDITION_FOG)
...
// TODO: Add additional status effects
// #define STATUS_FROSTBITE
// #define STATUS_STUNNED
// #define STATUS_SINGED
// #define STATUS_YAWNED
